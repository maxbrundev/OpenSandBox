...
OpenSandBox::Rendering::Entities::Light::Light(Maths::Transform& p_tranform, ELightType p_type) : type(static_cast<float>(p_type)), m_transform(p_tranform)
{
}

glm::mat4 OpenSandBox::Rendering::Entities::Light::GenerateMatrix() const
{
	glm::mat4 result;
