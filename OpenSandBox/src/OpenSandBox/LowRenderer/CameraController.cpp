...
OpenSandBox::LowRenderer::CameraController::CameraController(Camera& p_camera, glm::vec3& p_position) :
...
void OpenSandBox::LowRenderer::CameraController::ProcessKeyboard(cameraMovement p_direction, float p_deltaTime)
{
...
void OpenSandBox::LowRenderer::CameraController::ProcessMouseMovement(float p_offsetX, float p_offsetY)
{
	if (m_rightMousePressed) 
	{
...
void OpenSandBox::LowRenderer::CameraController::ProcessMouseScroll(float p_offsetY)
{
...
void OpenSandBox::LowRenderer::CameraController::Update(float p_deltaTime)
{
...
void OpenSandBox::LowRenderer::CameraController::SetPosition(const glm::vec3& p_position)
{
	m_position = p_position;
}

void OpenSandBox::LowRenderer::CameraController::SetPosition(float p_posX, float p_posY, float p_posZ)
{
	m_position.x = p_posX;
	m_position.y = p_posY;
	m_position.z = p_posZ;
...
const glm::vec3& OpenSandBox::LowRenderer::CameraController::GetPosition() const
{
	return m_position;
}

void OpenSandBox::LowRenderer::CameraController::HandleInputs(float p_deltaTime)
{
	if (m_rightMousePressed) 
	{
...
void OpenSandBox::LowRenderer::CameraController::HandleMouse()
{
	if (m_rightMousePressed)
	{
		double posX;
...
OpenSandBox::LowRenderer::Camera& OpenSandBox::LowRenderer::CameraController::GetCamera()
{
	return m_camera;
}
