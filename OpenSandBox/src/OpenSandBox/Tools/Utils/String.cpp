...
{
	size_t characterCount = p_path.find_last_of(OpenSandBox::Data::Constants::FORWARDSLASH) + 1;

	characterCount = characterCount > 0 ? characterCount :  p_path.find_last_of(OpenSandBox::Data::Constants::BACKSLASH) + 1;
...
{
	const size_t characterCount = p_file.find_last_of(OpenSandBox::Data::Constants::DOT);
