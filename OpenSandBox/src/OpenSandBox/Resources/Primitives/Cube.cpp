...
#include "OpenSandBox/Resources/Primitives/Cube.h"

std::vector<OpenSandBox::PrimitivesShapes::Vertex> OpenSandBox::PrimitivesShapes::Cube::m_vertices;
glm::vec3 OpenSandBox::PrimitivesShapes::Cube::m_positions[8];
glm::vec3 OpenSandBox::PrimitivesShapes::Cube::m_normals[6];
glm::vec2 OpenSandBox::PrimitivesShapes::Cube::m_textureCoordinates[4];
bool OpenSandBox::PrimitivesShapes::Cube::m_initialized = false;

void OpenSandBox::PrimitivesShapes::Cube::Setup()
{
	if (!m_initialized)
	{
		m_initialized = true;
...
void OpenSandBox::PrimitivesShapes::Cube::InitCubePositions()
{
...
void OpenSandBox::PrimitivesShapes::Cube::InitCubeTextureCoordinates()
{
...
void OpenSandBox::PrimitivesShapes::Cube::InitCubeNormals()
{
...
void OpenSandBox::PrimitivesShapes::Cube::InitCubeVertices()
{
...
void OpenSandBox::PrimitivesShapes::Cube::CreateTriangle(uint8_t pos1, uint8_t pos2, uint8_t pos3, uint8_t text1,
...
std::vector<OpenSandBox::PrimitivesShapes::Vertex>& OpenSandBox::PrimitivesShapes::Cube::GetVertices()
{
	return m_vertices;
}
