...
OpenSandBox::Resources::Mesh::Mesh(const std::vector<Geometry::Vertex>& p_vertices, const std::vector<uint32_t>& p_indices, uint32_t p_materialIndex) :
...
OpenSandBox::Resources::Mesh::~Mesh()
{
	Unbind();
}

void OpenSandBox::Resources::Mesh::Bind() const
{
	m_vertexArray.Bind();
}

void OpenSandBox::Resources::Mesh::Unbind() const
{
	m_vertexArray.Unbind();
}

uint32_t OpenSandBox::Resources::Mesh::GetVertexCount() const
{
	return m_vertexCount;
}

uint32_t OpenSandBox::Resources::Mesh::GetIndexCount() const
{
	return m_indicesCount;
}

uint32_t OpenSandBox::Resources::Mesh::GetMaterialIndex() const
{
	return m_materialIndex;
}

void OpenSandBox::Resources::Mesh::InitBuffers(const std::vector<Geometry::Vertex>& p_vertices, const std::vector<uint32_t>& p_indices)
{
