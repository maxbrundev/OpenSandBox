...
std::string OpenSandBox::Resources::Loaders::TextureLoader::__FILE_TRACE;

OpenSandBox::Resources::Texture* OpenSandBox::Resources::Loaders::TextureLoader::Create(std::string p_filePath, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, ETextureType p_textureType, bool p_flipVertically, bool p_generateMipmap)
{
...
OpenSandBox::Resources::Texture* OpenSandBox::Resources::Loaders::TextureLoader::CreateColor(uint32_t p_data, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, bool p_generateMipmap)
{
	GLuint textureID;
	glGenTextures(1, &textureID);
	glBindTexture(GL_TEXTURE_2D, textureID);
...
void OpenSandBox::Resources::Loaders::TextureLoader::Reload(const Texture& p_texture, const std::string& p_filePath, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, ETextureType p_textureType, bool p_flipVertically, bool p_generateMipmap)
{
...
bool OpenSandBox::Resources::Loaders::TextureLoader::Destroy(Texture*& p_textureInstance)
{
...
bool OpenSandBox::Resources::Loaders::TextureLoader::Delete(Texture* p_textureInstance)
{
	if (p_textureInstance)
	{
		glDeleteTextures(1, &p_textureInstance->id);
