...
std::string OpenSandBox::Resources::Loaders::ShaderLoader::__FILE_TRACE;

OpenSandBox::Resources::Shader* OpenSandBox::Resources::Loaders::ShaderLoader::Create(std::string p_filePath)
{
...
OpenSandBox::Resources::Shader* OpenSandBox::Resources::Loaders::ShaderLoader::CreateFromSource(const std::string& p_vertexShader, const std::string& p_fragmentShader)
{
...
void OpenSandBox::Resources::Loaders::ShaderLoader::Recompile(Shader& p_shader, const std::string& p_filePath)
{
	__FILE_TRACE = p_filePath;
...
bool OpenSandBox::Resources::Loaders::ShaderLoader::Destroy(Shader*& p_shaderInstance)
{
	if (p_shaderInstance)
	{
...
bool OpenSandBox::Resources::Loaders::ShaderLoader::Delete(Shader* p_shaderInstance)
{
	if (p_shaderInstance)
	{
		glDeleteProgram(p_shaderInstance->id);
...
std::pair<std::string, std::string> OpenSandBox::Resources::Loaders::ShaderLoader::ParseShader(const std::string& p_filePath)
{
...
std::string OpenSandBox::Resources::Loaders::ShaderLoader::Parse(const std::string& p_filePath)
{
	std::ifstream stream(p_filePath);
	std::string line;
...
uint32_t OpenSandBox::Resources::Loaders::ShaderLoader::CreateShader(const std::string &p_vertexSources, const std::string& p_fragmentSources)
{
...
uint32_t OpenSandBox::Resources::Loaders::ShaderLoader::CompileShader(uint32_t p_type, const std::string& p_source, uint32_t p_program)
{
