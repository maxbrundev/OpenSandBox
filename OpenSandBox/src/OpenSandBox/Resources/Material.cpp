...
OpenSandBox::Resources::Material::Material()
{
...
void OpenSandBox::Resources::Material::Bind(const Texture* p_emptyTexture) const
{
	if (HasShader())
	{
		m_shader->Bind();
...
void OpenSandBox::Resources::Material::Unbind() const
{
	if (HasShader())
	{
		m_shader->Unbind();
...
void OpenSandBox::Resources::Material::FillTextures(std::unordered_map<ETextureType, std::shared_ptr<Texture>> p_textures)
{
	m_textures = std::move(p_textures);
}

void OpenSandBox::Resources::Material::ResetToPreviousShader()
{
...
void OpenSandBox::Resources::Material::SetShader(Shader* p_shader)
{
...
void OpenSandBox::Resources::Material::SetTexture(Texture* p_texture)
{
	for(auto& [type, texture] : m_textures)
	{
		if(type == p_texture->type)
		{
...
void OpenSandBox::Resources::Material::SetBlendable(bool p_blendable)
{
	m_blendable = p_blendable;
}

void OpenSandBox::Resources::Material::SetBackfaceCulling(bool p_backfaceCulling)
{
	m_backfaceCulling = p_backfaceCulling;
}

void OpenSandBox::Resources::Material::SetFrontfaceCulling(bool p_frontfaceCulling)
{
	m_frontfaceCulling = p_frontfaceCulling;
}

void OpenSandBox::Resources::Material::SetDepthTest(bool p_depthTest)
{
	m_depthTest = p_depthTest;
}

void OpenSandBox::Resources::Material::SetDepthWriting(bool p_depthWriting)
{
	m_depthWriting = p_depthWriting;
}

void OpenSandBox::Resources::Material::SetColorWriting(bool p_colorWriting)
{
	m_colorWriting = p_colorWriting;
}

void OpenSandBox::Resources::Material::SetGPUInstances(uint64_t p_instances)
{
	m_gpuInstances = p_instances;
}

void OpenSandBox::Resources::Material::SetName(std::string p_name)
{
	m_name = std::move(p_name);
}

const OpenSandBox::Resources::Shader* OpenSandBox::Resources::Material::GetShader() const
{
	return m_shader;
}

bool OpenSandBox::Resources::Material::HasShader() const
{
	return m_shader != nullptr;
}

void OpenSandBox::Resources::Material::FillUniform()
{
	m_uniformsData.clear();
...
const std::unordered_map<OpenSandBox::Resources::ETextureType, std::shared_ptr<OpenSandBox::Resources::Texture>>& OpenSandBox::Resources::Material::GetTextures()
{
	return m_textures;
}

const std::string& OpenSandBox::Resources::Material::GetName()
{
	return m_name;
}

const std::map<std::string, std::any>& OpenSandBox::Resources::Material::GetUniformsData()
{
	return m_uniformsData;
}

bool OpenSandBox::Resources::Material::IsBlendable() const
{
	return m_blendable;
}

bool OpenSandBox::Resources::Material::HasBackfaceCulling() const
{
	return m_backfaceCulling;
}

bool OpenSandBox::Resources::Material::HasFrontfaceCulling() const
{
	return m_frontfaceCulling;
}

bool OpenSandBox::Resources::Material::HasDepthTest() const
{
	return m_depthTest;
}

bool OpenSandBox::Resources::Material::HasDepthWriting() const
{
	return m_depthWriting;
}

bool OpenSandBox::Resources::Material::HasColorWriting() const
{
	return m_colorWriting;
}

uint64_t OpenSandBox::Resources::Material::GetGPUInstances() const
{
