...
OpenSandBox::Maths::Transform::Transform(const glm::vec3 & p_position, const glm::vec3 & p_rotation, const glm::vec3 & p_scale) : m_parent(nullptr)
{
	GenerateMatrices(p_position, p_rotation, p_scale);
}

OpenSandBox::Maths::Transform::~Transform()
{
...
void OpenSandBox::Maths::Transform::GenerateMatrices(glm::vec3 p_position, glm::vec3 p_rotation, glm::vec3 p_scale)
{
...
void OpenSandBox::Maths::Transform::UpdateWorldMatrix()
{
...
bool OpenSandBox::Maths::Transform::HasParent() const
{
	return m_parent != nullptr;
}

void OpenSandBox::Maths::Transform::TranslateLocal(const glm::vec3& p_translation)
{
	SetLocalPosition(m_localPosition + p_translation);
}

void OpenSandBox::Maths::Transform::RotateLocal(const glm::vec3& p_rotation)
{
	SetLocalRotation(m_localRotation + p_rotation);
}

void OpenSandBox::Maths::Transform::ScaleLocal(const glm::vec3& p_scale)
{
	SetLocalScale(m_localScale * p_scale);
}

void OpenSandBox::Maths::Transform::SetParent(Transform& p_parent)
{
	m_parent = &p_parent;
...
bool OpenSandBox::Maths::Transform::RemoveParent()
{
	if(m_parent != nullptr)
	{
...
void OpenSandBox::Maths::Transform::HandleParentTransformCallback(ETransformState p_state)
{
	switch (p_state)
	{
...
uint64_t OpenSandBox::Maths::Transform::AddChildrenCallback(const std::function<void(ETransformState)>& p_callback)
{
...
void OpenSandBox::Maths::Transform::SetLocalPosition(glm::vec3 p_newPosition)
{
	GenerateMatrices(p_newPosition, m_localRotation, m_localScale);
}

void OpenSandBox::Maths::Transform::SetLocalRotation(glm::vec3 p_newRotation)
{
	GenerateMatrices(m_localPosition, p_newRotation, m_localScale);
}

void OpenSandBox::Maths::Transform::SetLocalScale(glm::vec3 p_newScale)
{
	GenerateMatrices(m_localPosition, m_localRotation, p_newScale);
}

void OpenSandBox::Maths::Transform::SetWorldPosition(glm::vec3 p_newPosition)
{
	GenerateMatrices(p_newPosition, m_worldRotation, m_worldScale);
}

void OpenSandBox::Maths::Transform::SetWorldRotation(glm::vec3 p_newRotation)
{
	GenerateMatrices(m_worldPosition, p_newRotation, m_worldScale);
}

void OpenSandBox::Maths::Transform::SetWorldScale(glm::vec3 p_newScale)
{
	GenerateMatrices(m_worldPosition, m_worldRotation, p_newScale);
}

const glm::vec3& OpenSandBox::Maths::Transform::GetLocalPosition() const
{
	return m_localPosition;
}

const glm::vec3& OpenSandBox::Maths::Transform::GetLocalRotationEuler() const
{
	return m_localRotation;
}

const glm::vec3& OpenSandBox::Maths::Transform::GetLocalScale() const
{
	return m_localScale;
}

const glm::vec3& OpenSandBox::Maths::Transform::GetWorldPosition() const
{
	return m_worldPosition;
}

const glm::vec3& OpenSandBox::Maths::Transform::GetWorldRotationEuler() const
{
	return m_worldRotation;
}

const glm::vec3& OpenSandBox::Maths::Transform::GetWorldScale() const
{
	return m_worldScale;
}

glm::vec3 OpenSandBox::Maths::Transform::GetWorldForward() const
{
...
glm::vec3 OpenSandBox::Maths::Transform::GetWorldUp() const
{
	return m_worldRotationQuat * glm::vec3(0.0f, 1.0f, 0.0f);
}

glm::vec3 OpenSandBox::Maths::Transform::GetWorldRight() const
{
	return m_worldRotationQuat * glm::vec3(1.0f, 0.0f, 0.0f);
}

glm::vec3 OpenSandBox::Maths::Transform::GetLocalForward() const
{
...
glm::vec3 OpenSandBox::Maths::Transform::GetLocalUp() const
{
	return m_localRotationQuat * glm::vec3(0.0f, 1.0f, 0.0f);
}

glm::vec3 OpenSandBox::Maths::Transform::GetLocalRight() const
{
	return m_localRotationQuat * glm::vec3(1.0f, 0.0f, 0.0f);
}

glm::mat4& OpenSandBox::Maths::Transform::GetLocalMatrix()
{
	return m_localMatrix;
}

glm::mat4& OpenSandBox::Maths::Transform::GetWorldMatrix()
{
	return m_worldMatrix;
}

void OpenSandBox::Maths::Transform::PreDecomposeWorldMatrix()
{
